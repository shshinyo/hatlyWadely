...
export interface NotFoundProblemDetails extends ProblemDetails {
  extra: {
    /** The property name value that caused the failure. */
    property: string;
...
export interface ValidationProblemDetails extends ProblemDetails {
  ...
  /// * Value - The property value that caused the failure.
  errors: { [key: string]: ErrorDescriber[] };
}

/** This response will be returned if can not find an entity in database. */
export interface ForbiddenProblemDetails extends ProblemDetails {
